...
export const DataUnionChainOption: FunctionComponent<DataUnionChainOptionProps> = ({
    ...
    const [existingDUAddress, setExistingDUAddress] = useState<Address | undefined>(
        undefined,
    )
    ...
    const handleExistingDUSelect = useCallback(
        ...
        <DropdownWrap>
            ...
            <DropdownOuter className={isSelected ? 'is-open' : ''}>
                <DropdownInner className={isSelected ? 'is-open' : ''}>
                    ...
                    <SubHeading>
                        You can deploy a new Data Union smart contract, or connect an
                        existing one.
                    </SubHeading>
                    <DeploymentSelectContainer>
                        ...
                        <DeploymentSelectorRadioContainer>
                            <StyledRadio
                                ...
                                disabled={existingDUOptions.length === 0}
                            />
                            <SelectField2
                                placeholder={
                                    existingDUOptions.length
                                        ? 'Select a Data Union'
                                        : "You don't have any deployed Data Unions"
                                }
                                options={existingDUOptions}
                                disabled={
                                    deployNewDU === true || !existingDUOptions.length
                                }
                                fullWidth={true}
