...
export const getDetailEditorDropdownPlaceholderStyles = (
...
export const getDetailEditorDropdownControlStyles = (
    styles: CSSObjectWithLabel,
    isFocused: boolean,
): CSSObjectWithLabel => {
...
export const getDetailEditorDropdownMenuStyles = (
    styles: CSSObjectWithLabel,
): CSSObjectWithLabel => {
    return {
        ...styles,
...
export const getDetailEditorDropdownMenuListStyles = (
    styles: CSSObjectWithLabel,
): CSSObjectWithLabel => {
    return {
        ...styles,
...
export const getDetailEditorDropdownOptionStyles = (
    styles: CSSObjectWithLabel,
    isSelected: boolean,
): CSSObjectWithLabel => {
    const styleObject: CSSObjectWithLabel = {
