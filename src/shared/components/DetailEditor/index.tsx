...
import {
    ...
    getDetailEditorDropdownPlaceholderStyles,
    getDetailEditorDropdownOptionStyles,
...
export const DetailEditor: FunctionComponent<DetailsEditorProps> = ({
    ...
    return (
        <DetailEditorDropdown isOpen={isOpen} toggle={handleToggle} className={className}>
                ...
                {showValue && (
                    <span
                        ...
                        className={
                            'value' +
                            (!value ? ' value-unset' : '') +
                            (defaultIcon || hasValueIcon ? ' has-icon' : '')
                        }
                    >
                        {valueToDisplay}
                    </span>
            ...
            <DropdownMenu>
                <div className={'header'}>
                    <span
                        ...
                        data-testid={'detailEditorInstructionText'}
                    >
                        {instructionText}
                    </span>
                    <span className={'optional'} data-testid={'detailEditorOptional'}>
                        {optional && 'Optional'}
                    </span>
                </div>
                {!selectOptions && (
                    <div>
                        ...
                        >
                            ...
                            <img
                                ...
                                className={
                                    'enter-icon ' +
                                    (inputIsFocused && inputValue ? 'visible' : '')
                                }
                        ...
                        {validationError && (
                            <span
                                data-testid={'detailEditorValidationError'}
                ...
                {selectOptions && (
                    <ReactSelect
                        ...
                        styles={{
                            placeholder: (styles) =>
                                getDetailEditorDropdownPlaceholderStyles(styles),
                            ...
                            menuList: (styles) =>
                                getDetailEditorDropdownMenuListStyles(styles),
                            option: (styles, props) =>
                                getDetailEditorDropdownOptionStyles(
                                    styles,
                                    props.isSelected,
