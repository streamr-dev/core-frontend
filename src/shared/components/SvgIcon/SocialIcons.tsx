...
export const Peepeth = ({ className }: Props) => (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className={className}>
        <g fill="currentColor" fillRule="evenodd">
            {/* eslint-disable-next-line max-len */}
            <path
                d="M22.665 12.513c-1.269-1.527-3.205-3.036-5.04-2.751-1.836.285-2.804 1.442-3.138 1.795.05-.872.801-3.07 2.97-3.07 3.672 0 5.008 3.07 5.208 4.026zm-21.313 0c.2-.956 1.535-4.026 5.207-4.026 2.17 0 2.92 2.198 2.97 3.07-.333-.353-1.3-1.51-3.137-1.795-1.836-.285-3.772 1.224-5.04 2.75z"
                opacity=".503"
            />
            {/* eslint-disable-next-line max-len */}
...
export const Web = ({ className }: Props) => (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className={className}>
        ...
        <path
            fill="#fff"
            fillRule="evenodd"
            d="M5.23 7.737A8 8 0 0 1 12 4a8 8 0 0 1 6.77 3.737l.01.016A7.96 7.96 0 0 1 20 12a7.96 7.96 0 0 1-1.227 4.26l-.002.003A8 8 0 0 1 12 20a8 8 0 0 1-6.77-3.737l-.01-.016A7.96 7.96 0 0 1 4 12a7.96 7.96 0 0 1 1.22-4.247zM13.393 19c.428-.627.789-1.486 1.06-2.498H9.546c.248.929.572 1.728.954 2.338q.727.16 1.5.16l.307-.007q.459-.02.9-.097l.289-.057zm-4.88-2.498H6.64a7 7 0 0 0 2.504 1.891c-.246-.563-.457-1.2-.629-1.891m6.342 1.891a7 7 0 0 0 2.505-1.891h-1.876a12 12 0 0 1-.629 1.891m-6.555-2.89a19.6 19.6 0 0 1-.295-3.001H5.018a6.96 6.96 0 0 0 .919 3zm9.762-.002a6.96 6.96 0 0 0 .92-3h-2.989a19.6 19.6 0 0 1-.295 3.001zm-3.382 0c.178-.924.287-1.94.313-3H9.006c.026 1.06.135 2.076.313 3zm-6.675-4a19.6 19.6 0 0 1 .295-3H5.936a6.96 6.96 0 0 0-.918 3zm6.988 0a18.5 18.5 0 0 0-.312-3H9.318c-.177.925-.286 1.94-.312 3zm3.07-3H15.7c.169.937.27 1.95.295 3h2.989a6.96 6.96 0 0 0-.92-3m-9.55-1c.172-.692.383-1.329.63-1.892l-.076.034A7 7 0 0 0 6.638 7.5zm8.848 0a7 7 0 0 0-2.505-1.892l.108.26c.2.496.375 1.044.52 1.632zM13.5 5.16A7 7 0 0 0 12 5l-.307.007a7 7 0 0 0-.9.097l-.29.056.103-.159c-.428.627-.789 1.486-1.06 2.499h4.908c-.249-.93-.573-1.729-.955-2.34"
        />
    </svg>
)
