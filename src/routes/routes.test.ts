import { define, buildRoutes } from '~/routes/index'
describe('route utils', () => {
    ...
    describe('define', () => {
        ...
        it('applies given params', () => {
            ...
            expect(
                r('/resource/:id/whatever/:id', {
                    id: 1,
                }),
            ).toEqual('/resource/1/whatever/1')
            expect(
                r('/resource/:id(val1|val2)', {
                    id: 'val1',
                }),
            ).toEqual('/resource/val1')
            expect(
                r('/resource/:id(val1|val2)/whatever/:whateverId(val3|val4)', {
                    id: 'val2',
                    whateverId: 'val4',
                }),
