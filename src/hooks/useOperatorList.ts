...
export const mapOperatorToElement = (operator: Operator): OperatorElement => {
    return {
        ...
        delegators: operator.delegators.map((d) => ({
            amount: toBN(d.delegatedDataWei),
        ...
        dataTokenBalance: toBN(operator.dataTokenBalanceWei),
        metadata: parseMetadata(operator),
        owner: operator.owner,
        nodes: operator.nodes,
        operatorTokenTotalSupply: toBN(operator.operatorTokenTotalSupplyWei),
        valueWithoutEarnings: toBN(operator.valueWithoutEarnings),
        valueUpdateBlockNumber: operator.valueUpdateBlockNumber,
        valueUpdateTimestamp: operator.valueUpdateTimestamp,
