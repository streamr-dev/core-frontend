...
import { productSchema, streamsSchema } from '../../../../modules/entities/schema'
import { initialState } from '../../../../modules/product/reducer'
...
jest.mock('../../../../modules/myPurchaseList/actions', () => (
    {
...
jest.mock('../../../../modules/purchase/actions', () => (
    {
