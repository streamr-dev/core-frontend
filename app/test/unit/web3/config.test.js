...
jest.mock('$shared/web3/abis/marketplace_old', () => (['m_old_test', 'm_old_values', 'm_old_only']))
...
describe('config', () => {
    ...
    describe('building the config', () => {
        ...
        it('gets the right config from env (new contract)', () => {
        ...
        it('gets the right config from env (old contract)', () => {
            delete process.env.NEW_MP_CONTRACT
            process.env.MARKETPLACE_CONTRACT_ADDRESS_OLD = 'mpAddress'
            process.env.DATA_TOKEN_CONTRACT_ADDRESS = 'dataTokenAddress'
            process.env.DAI_TOKEN_CONTRACT_ADDRESS = 'daiTokenAddress'
            process.env.WEB3_REQUIRED_NETWORK_ID = '1'
            process.env.WEB3_PUBLIC_HTTP_PROVIDER = 'https://dummy'
            ...
            assert.deepStrictEqual(getConfig(), {
                ...
                marketplace: {
                    abi: ['m_old_test', 'm_old_values', 'm_old_only'],
                    address: 'mpAddress',
                },
                communityProduct: {
                    abi: ['c_test', 'c_values', 'c_only'],
