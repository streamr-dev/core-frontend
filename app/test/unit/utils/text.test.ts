...
describe('text utils', () => {
    describe('truncate', () => {
        ...
        it('truncates paths starting with eth address', () => {
            expect(truncate('0xa3d1F77ACfF0060F7213D7BF3c7fEC78df847De1/test/my-stream')).toBe(
                '0xa3d...47De1/test/my-stream',
            )
            expect(truncate('0xA3D1F77ACFF0060F7213D7BF3C7fEC78DF847DE1/test/my-stream')).toBe(
                '0xA3D...47DE1/test/my-stream',
            )
        ...
        it('truncates address in the middle of text', () => {
            expect(truncate('address is 0xA3D1F77ACFF0060F7213D7BF3C7fEC78DF847DE1 inside text')).toBe(
                'address is 0xA3D...47DE1 inside text',
            )
        })
        ...
        it('truncates transaction hash', () => {
            expect(truncate('0x8b549d1526d0f6168eed061041d6cb5243c2c283b6d35cf41fe9c95b1e606ff1')).toBe('0x8b5...06ff1')
        })
    })
