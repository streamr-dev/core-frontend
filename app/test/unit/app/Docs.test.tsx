...
jest.mock('$docs/components/Pages/Marketplace/CreatingDataProducts', () => ({
    __esModule: true,
    default: () => '/docs/marketplace/creating-data-products',
}))
