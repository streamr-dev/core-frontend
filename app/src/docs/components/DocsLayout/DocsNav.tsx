        ...
        <div className={className}>
            <Navbar>
                ...
                <Navbar.Item data-desktop-only>
                    <NavDropdown
                        toggle={<NavLink>Discover</NavLink>}
                        menu={
                            <Menu>
                ...
                <Navbar.Item data-desktop-only>
                    <NavDropdown toggle={<NavLink>Project</NavLink>} menu={<ProjectMenu />} />
                </Navbar.Item>
                <Navbar.Item data-desktop-only>
                    <NavDropdown highlight toggle={<NavLink>Developers</NavLink>} menu={<DevelopersMenu />} />
                </Navbar.Item>
                <Navbar.Item data-desktop-only>
                    <NavDropdown
                        toggle={<NavLink>Community</NavLink>}
                        menu={
                            <Menu>
                                <Menu.Group>
