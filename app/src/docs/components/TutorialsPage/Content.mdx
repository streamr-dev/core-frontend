...
import RuuviSensor from './ruuvi-sensor.png'
import RaspberryPi from './raspberry-pi.png'
import RuuviSensorInner from './ruuvi-sensor-inside.png'
import GoogleApi from './google-api.png'
import GoogleDev from './google-dev.png'
import GoogleAuth from './google-auth.png'
import OauthPlay from './oauth-play.png'
import DataStream from './data-stream.png'
...
<SyntaxHighlighter language='javascript' style={githubGist} wrapLines>npm install ruuvi-streamr --save</SyntaxHighlighter>
...
<SyntaxHighlighter language='javascript' style={githubGist} showLineNumbers wrapLines>{libraryUsage}</SyntaxHighlighter>
...
<SyntaxHighlighter language='javascript' style={githubGist} showLineNumbers wrapLines>{ruuviCommands}</SyntaxHighlighter>
...
If you want to learn in more details on how to push data from Ruuvi to Streamr, feel free to visit our Javascript ruuvi-streamr library at this link.
...
<SyntaxHighlighter language='javascript' style={githubGist} showLineNumbers wrapLines>
...
<SyntaxHighlighter language='python' style={githubGist} showLineNumbers wrapLines>{pythonScript}</SyntaxHighlighter>
