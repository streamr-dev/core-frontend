...
-   <a
        href="https://github.com/streamr-dev/network-monorepo/tree/main/packages/client"
        target="_blank"
        rel="noopener noreferrer"
    >
        JavaScript client library (official)
    </a>{" "}
...
-   <a
        href="https://github.com/streamr-dev/streamr-client-java"
        target="_blank"
        rel="noopener noreferrer"
    >
        Java client library (official)
    </a>
-   <a
        href="https://github.com/streamr-dev/streamr-client-python"
        target="_blank"
        rel="noopener noreferrer"
    >
        Python client library (community)
    </a>
