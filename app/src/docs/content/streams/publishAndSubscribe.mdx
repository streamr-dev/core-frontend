...
import { ClientSub, ClientPub, InputsAndOutputs } from './code/tutorials'
...
-   <a href="https://www.npmjs.com/package/streamr-client" target="_blank" rel="noopener noreferrer">
        Streamr Client NPM
    </a>
-   <a
        href="https://github.com/streamr-dev/network-monorepo/blob/main/packages/client/README.md"
        target="_blank"
        rel="noopener noreferrer"
    >
        Streamr Client Github
    </a>
...
<Image src={StreamEditorPreview} highResSrc={StreamEditorPreview2x} alt="Stream Editor Preview" />
