...
The easiest way to work with streams is to use the JavaScript client, which works in Node.js as well as the browser. See the <Link to={docsLinks.sdks}>SDKs section</Link> for the official and community-maintained client libraries available for various languages.
