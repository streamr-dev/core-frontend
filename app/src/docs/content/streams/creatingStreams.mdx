...
ENS names allow streams to have human readable names, for example `mydomain.eth/traffic/helsinki`. If you haven’t used an ENS name before, you can easily create one with a small amount of ETH on <a href="https://ens.domains" target="_blank" rel="noopener noreferrer">ENS Domains</a>. Your purchased addresses will automatically appear in the stream editor for immediate usage. At a future date, the stream registry will live on the blockchain.
