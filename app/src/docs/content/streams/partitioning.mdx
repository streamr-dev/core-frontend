...
import MessagePartitioningImage from './images/message-partitioning.png'
import StreamAndPartitionsImage from './images/stream-and-partitions.png'
...
The `publish` methods in the <Link to={links.docs.SDKs.root}>Streamr SDKs</Link> usually take an optional `partitionKey` parameter. For example, in the JS client:
