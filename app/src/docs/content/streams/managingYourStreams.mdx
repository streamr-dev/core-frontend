...
<Image border src={StreamListing} highResSrc={StreamListing2x} alt="Stream Listing" />
...
<Image src={StreamDetails} highResSrc={StreamDetails2x} alt="Stream Details" />
...
<Image src={StreamConfigure} highResSrc={StreamConfigure2x} alt="Stream Configure" />
...
<Image src={StreamPreview} highResSrc={StreamPreview2x} alt="Stream Preview" />
