...
export const InputsAndOutputs = `// Define inputs and outputs here
...
export const ClientSub = `const streamr = new StreamrClient({
    auth: {
...
export const ClientPub = `// Run a Streamr node right inside your JS app
