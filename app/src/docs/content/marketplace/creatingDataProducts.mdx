...
<Image src={ProductsOverview} highResSrc={ProductsOverview2x} alt="Products Overview" />
...
<Image src={StreamSelector} highResSrc={StreamSelector2x} alt="Stream Selector" />
...
<Image src={MDEditor} highResSrc={MDEditor2x} alt="Text MD Editor" />
...
<Image src={PriceEditor} highResSrc={PriceEditor2x} alt="Price Editor" />
...
<Image src={WalletAccess} highResSrc={WalletAccess2x} alt="Wallet Access" />
