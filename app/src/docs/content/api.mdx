...
- <a href="https://github.com/streamr-dev/streamr-client-javascript" target="_blank">JavaScript (official)</a> 
...
- <a href="https://github.com/streamr-dev/streamr-client-java" target="_blank">Java (official)</a>
- <a href="https://github.com/streamr-dev/streamr-client-python" target="_blank">Python Library (community)</a>
