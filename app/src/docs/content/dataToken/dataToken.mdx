...
*A publisher app publishes a stream, and their node relays the stream*
...
*Wanting better service for the stream, a sponsor deploys and funds a Bounty in $DATA*
...
*Broker nodes watching for bounties stake $DATA and join the stream overlay*
...
*Delegators can help brokers join more streams and earn yield on their stake*
