...
import PublisherApp from './images/publisher-app.png'
import Pic2 from './images/Tokenomics-2@2x.png'
import Pic3 from './images/Tokenomics-3@2x.png'
import Pic4 from './images/Tokenomics-4@2x.png'
import Pic5 from './images/Tokenomics-5@2x.png'

# The DATA Token
The [DATA](https://etherscan.io/address/0x8f693ca8d21b157107184d29d398a8d082b38b76) token is an ERC-20 token used for project governance, to incentivize the Network, to delegate stake on broker nodes, and for Marketplace payments. The token has also been bridged to the <a target="_blank" rel="noopener noreferrer" href="https://www.xdaichain.com">xDai sidechain</a> with further multichain support on the horizon. 
...
<Image
  src={Pic3}
  alt=""
  figCaption="Broker nodes watching for bounties stake $DATA and join the stream overlay"
/>
...
<Image
  src={Pic4}
  alt=""
  figCaption="After relaying the stream for an agreed period of time, nodes claim rewards"
/>
...
<Image
  src={Pic5}
  alt=""
  figCaption="Delegators can help brokers join more streams and earn yield on their stake"
/>
