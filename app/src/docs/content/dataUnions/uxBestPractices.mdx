...
<Image src={KnowYourResponsibility} highResSrc={KnowYourResponsibility2x} alt="Private key handling" />
...
<Image src={WalletAddress} highResSrc={WalletAddress2x} alt="Wallet addresses" />
...
<Image src={FiatCurrencyDisplay} highResSrc={FiatCurrencyDisplay2x} alt="Fiat currency display" />
