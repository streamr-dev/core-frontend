...
<figure>
    <picture>
        <img
            ...
            className={docsStyles.hideOnMobile}
        />
        <img
            src={RevenueAndDataMobile}
            srcSet={`${RevenueAndDataMobile2x} 2x`}
            alt="Introduction to Data Unions"
            className={docsStyles.showOnMobile}
        />
    </picture>
...
- You must have a minimum of 1 user to publish, but the larger the number<br />
