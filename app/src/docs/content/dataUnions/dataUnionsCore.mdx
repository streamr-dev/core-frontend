...
The Stats view provides an overview of the Data Union as well as it's members and subscribers over time, while the Members view allows you to manage manual member join requests (requests that did not have the secret).
