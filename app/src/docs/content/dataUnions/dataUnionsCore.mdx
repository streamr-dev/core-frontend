...
}} /> is needed to publish the Data union to the Marketplace. Once enough members have joined, you can publish the Data Union by clicking Publish from the action bar. Your Data Union will be published on the Marketplace once the Ethereum blockchain has confirmed your transaction.
