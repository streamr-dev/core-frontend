...
Other than the sections below, the process is similar to creating a data product. Please see the section about <Link to={links.docs.products.introToProducts}>creating Data Products</Link> before proceeding with this article.
...
Creating a Data Union product starts with deploying the Data Union smart contract. A Data Union is identified by the address of its smart contract. The admin who deployes the contract then becomes the owner of the contract as well.
