...
import Deploy from './images/data_unions_in_core_02_deploy.jpg'
import Deploy2x from './images/data_unions_in_core_02_deploy@2x.jpg'

import Managing from './images/data_unions_in_core_03_managing.jpg'
import Managing2x from './images/data_unions_in_core_03_managing@2x.jpg'

# Build a Data Union with Core

To create a Data Union in Core, go to Core > Products, click Create and choose Data Union as the product type. Other than the sections below, the process is similar to creating a Data Product. If you haven’t made one before, please check out <Link to={links.docs.products.root}>Creating a Data Product</Link> before proceeding with this article.
...
<figure>
    <picture>
        <img
            src={Managing}
            srcSet={`${Managing2x} 2x`}
            alt="Managing the Data Union"
        />
    </picture>
</figure>
