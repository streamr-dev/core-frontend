...
### Publish to a stream
The easiest way to push data to a stream is to use one of our <Link to={docsLinks.sdk}>SDKs</Link>, currently available in <a target="_blank" rel="noopener noreferrer" href="https://github.com/streamr-dev/streamr-client-javascript">Javascript</a>, <a target="_blank" rel="noopener noreferrer" href="https://github.com/streamr-dev/streamr-client-java">Java</a>. Client libraries for other languages are on the roadmap. Here is an example of publishing data to a stream using Streamr Javascript client.
...
Here is the example from the Streamr JavaScript client <a target="_blank" rel="noopener noreferrer" href="https://github.com/streamr-dev/streamr-client-javascript">readme</a> on how to subscribe to a stream.
