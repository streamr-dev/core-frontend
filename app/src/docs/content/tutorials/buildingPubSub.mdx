...
- <Link to={links.docs.gettingStarted.root}>Got your API key or connected your Ethereum account</Link>
- <Link to={links.docs.streams.root}>Created your first stream</Link> 
...
Additionally, you can interact with the Streamr API using any HTTP library of your choice. You will find all the details in the <Link to={links.docs.api.root}>API section</Link>, but here’s a brief rundown:
...
Along with publishing data to a stream, this is best done with one of our <Link to={links.docs.SDKs.root}>SDKs</Link>. 
