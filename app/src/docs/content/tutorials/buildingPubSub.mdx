...
### Subscribe to data
Along with publishing data to a stream, this is best done with one of our <Link to={docsLinks.sdks}>SDKs</Link>. Here is the given example from the Streamr JavaScript client <a target="_blank" href="https://github.com/streamr-dev/streamr-client-javascript">readme</a>.
