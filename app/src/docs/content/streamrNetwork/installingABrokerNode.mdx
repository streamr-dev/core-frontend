...
```
docker run -it -v $(cd ~/.streamrDocker; pwd):/root/.streamr streamr/broker-node:dev bin/config-wizard
```
...
```
cd ~/.streamrDocker
docker run -it -v ${pwd}:/root/.streamr streamr/broker-node:dev bin/config-wizard
```
...
```
docker run -it -p 7170:7170 -p 7171:7171 -p 1883:1883 -v $(cd ~/.streamrDocker; pwd):/root/.streamr streamr/broker-node:dev
```
...
```
cd ~/.streamrDocker
docker run -p 7170:7170 -p 7171:7171 -p 1883:1883 -it -v ${pwd}:/root/.streamr streamr/broker-node:dev
```
