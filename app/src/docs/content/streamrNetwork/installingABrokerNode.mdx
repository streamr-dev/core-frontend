...
```
docker run --interactive --tty --publish 7170:7170 --publish 7171:7171 --publish 1883:1883 --volume $(cd ~/.streamrDocker && pwd):/home/streamr/.streamr streamr/broker-node:latest
```
...
```
cd ~/.streamrDocker
docker run --interactive --tty --publish 7170:7170 --publish 7171:7171 --publish 1883:1883 --volume ${pwd}:/home/streamr/.streamr streamr/broker-node:latest
```
