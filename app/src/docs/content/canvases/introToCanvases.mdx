...
Use the **SendToStream** module if you want to send data that has been generated inside the canvas, into a stream. Inside the module, start typing the name of your stream and it will autocomplete for you. Remember to configure the fields of your stream before using this module as the module's inputs are defined by it's fields. Learn more about fields in the <Link to={`${links.docs.streams}#stream-data-fields`}>streams docs</Link>.
