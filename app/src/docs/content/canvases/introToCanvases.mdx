...
import CanvasDemo from './images/canvasDemo.png'
import RoundToStep from './images/roundToStep.png'
import SendToStream from './images/sendToStream.png'
import AndModule from './images/andModule.png'
import BasicCanvas from './images/basicCanvas.png'
import HistoricalRealtime from './images/historicalRealtime.png'
import AddTramStream from './images/addTramStream.png'
import ModuleBrowser from './images/moduleBrowser.png'
import ConnectingTypes from './images/connectingTypes.png'
import ConnectingTypes2 from './images/connectingTypes2.png'
import InputTypes from './images/inputTypes.png'
import ConnectingStreamToModule from './images/connectingStreamToModule.png'
import StartHistoricalRun from './images/startHistoricalRun.png'
import PlaybackOptions from './images/playbackOptions.png'
import StartRealtimeRun from './images/startRealtimeRun.png'
import StopRealtimeRun from './images/stopRealtimeRun.png'
import NoRepeat from './images/noRepeat.png'
...
When you place a stream on the canvas, you effectively *subscribe* to a real-time data source. To add a stream, just start typing its name in module browser search. The stream name will autocomplete as you type. Realtime events are now available at the output endpoints.
...
Use the **SendToStream** module if you want to send data that has been generated inside the canvas, into a stream. Inside the module, start typing the name of your stream and it will autocomplete for you. Remember to configure the fields of your stream before using this module as the module's inputs are defined by it's fields. Learn more about fields in the <Link to={`${links.docs.streams.root}#stream-data-fields`}>streams docs</Link>.
...
You can run your canvas in one of two ways - **historical** or **real-time** mode.
