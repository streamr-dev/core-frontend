...
<figure>
  <picture>
    <source srcSet={CanvasModesMobile2x} media="(max-width: 575px)" />
    <img
      src={CanvasModes}
      srcSet={`${CanvasModes2x} 2x`}
      alt="Canvas Modes"
    />
  </picture>
</figure>
...
<figure>
  <picture>
    <source srcSet={RealtimeModeMobile2x} media="(max-width: 575px)" />
    <img
      src={RealtimeMode}
      srcSet={`${RealtimeMode2x} 2x`}
      alt="Realtime Mode"
    />
  </picture>
</figure>
...
<figure>
  <picture>
    <source srcSet={HistoricalModeMobile2x} media="(max-width: 575px)" />
    <img
      src={HistoricalMode}
      srcSet={`${HistoricalMode2x} 2x`}
      alt="Historical Mode"
    />
  </picture>
</figure>
...
<figure>
  <picture>
    ...
    <img
      ...
      srcSet={`${PlaybackSpeedDesktop2x} 2x`}
      alt="Playback speed"
    />
  </picture>
</figure>
