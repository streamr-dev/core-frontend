...
The easiest way to push data to a stream is to use the one of our <Link to={links.newdocs.SDKs}>SDKs</Link>, currently available in [Javascript](https://github.com/streamr-dev/streamr-client-javascript), [Java](https://github.com/streamr-dev/streamr-client-java) and a community contributed version in [Python](https://github.com/streamr-dev/streamr-client-python). Client libraries for other languages are on the roadmap.
...
Along with Publishing data to a stream, this is best done with one of our <Link to={links.newdocs.SDKs}>SDKs</Link>, currently available in [Javascript](https://github.com/streamr-dev/streamr-client-javascript) as mentioned above. 
