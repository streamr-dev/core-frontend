...
const TransactionList = () => {
    ...
    useEffect(() => {
        ...
        Promise.all([loadProducts()]).then(getTransactionEvents)
    }, [clearTransactionList, loadProducts, getTransactionEvents])
    const isLoading = !!(fetchingTransactions || fetchingProducts)
    return (
        <Layout loading={isLoading} headerSearchComponent={<Search.Disabled />}>
            <CoreHelmet title="Transactions" />
            <StyledListContainer>
                {!isLoading && transactions && transactions.length <= 0 && <NoTransactionsView />}
                {transactions && transactions.length > 0 && (
                    <TransactionListComponent>
                        <TransactionListComponent.Header>
                            <TransactionListComponent.HeaderItem>Name</TransactionListComponent.HeaderItem>
                            <TransactionListComponent.HeaderItem>Type</TransactionListComponent.HeaderItem>
                            <TransactionListComponent.HeaderItem>Transaction</TransactionListComponent.HeaderItem>
                            <TransactionListComponent.HeaderItem>When</TransactionListComponent.HeaderItem>
                            <TransactionListComponent.HeaderItem>Value</TransactionListComponent.HeaderItem>
                            <TransactionListComponent.HeaderItem>Gas</TransactionListComponent.HeaderItem>
                        ...
                        {transactions.map(
                            ({
                                ...
                                return (
                                    <TransactionListComponent.Row key={id} id={id}>
                                        ...
                                        <TransactionListComponent.Item>
                                            <StatusIcon status={mapState(state)} tooltip={statusLabels[state]} />
                                        </TransactionListComponent.Item>
