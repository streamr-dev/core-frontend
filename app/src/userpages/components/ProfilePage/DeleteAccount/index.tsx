...
const DeleteAccount = () => {
    ...
    return (
        <div>
            <Description>
                Unlike other companies that deactivate your account but retain your data, if you delete your Streamr
                account, all your data is deleted from our servers and will be unrecoverable. Please proceed with
                caution.
            </Description>
            <RemoveButton
                kind="destructive"
