...
const ProfileSettings = () => {
    ...
    const doUpdateUserName = useCallback(
        (name: $ElementType<User, 'name'>) => dispatch(updateCurrentUserName(name)),
        [dispatch],
    )
    const doUpdateUserEmail = useCallback(
    ...
    return (
        <Root>
            <AvatarWrapper>
                <AvatarCircle>
                    <AvatarImage src={user.imageUrlLarge} username={user.username} upload />
                </AvatarCircle>
                <UploadWrapper>
                    <Button
                        kind="secondary"
                    ...
                    <UploadHelpText>JPG or PNG, at least 256px</UploadHelpText>
                </UploadWrapper>
            </AvatarWrapper>
            <InputRow>
                <Label htmlFor="userFullname">Your Name</Label>
                <Text
                    id="userFullname"
                    name="name"
                    value={user.name || ''}
