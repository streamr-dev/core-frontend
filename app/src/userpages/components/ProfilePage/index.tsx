...
export const ProfilePage: FunctionComponent = () => {
    ...
    const isLoading = !!(isSavePending || isDeleteAccountPending || isAvatarUploadPending)
    return (
        <CoreLayout
            nav={false}
            navComponent={
...
const LoadingView = () => <CoreLayout nav={false} navComponent={<Toolbar loading actions={{}} altMobileLayout />} />
