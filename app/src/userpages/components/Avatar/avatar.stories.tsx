...
stories.add('default', () => <Avatar user={emailUser}>{emailUser.username}</Avatar>)
stories.add('default (mobile)', () => <Avatar user={emailUser}>{emailUser.username}</Avatar>, {
    viewport: {
        defaultViewport: 'xs',
    },
})
stories.add('with image', () => <Avatar user={emailUserWithImage}>{emailUserWithImage.username}</Avatar>)
stories.add('with image (mobile)', () => <Avatar user={emailUserWithImage}>{emailUserWithImage.username}</Avatar>, {
    viewport: {
        defaultViewport: 'xs',
    },
})
