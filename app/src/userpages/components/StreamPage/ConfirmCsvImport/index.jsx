...
export class ConfirmCsvImportView extends Component<Props, State> {
    ...
    componentWillMount() {
        if (this.props.location.state && this.props.location.state.fileUrl) {
            ...
            this.props.history.push(`${links.userpages.streamShow}/${this.props.stream.id}`)
        }
    }
        ...
        if (this.state.fileUrl && this.props.stream) {
            this.props.confirmCsvUpload(this.props.stream.id, this.state.fileUrl, dateFormat, timestampColumnIndex)
                .then(() => {
                    ...
                    this.props.history.push(`${links.userpages.streamShow}/${id}`)
                })
        }
    }
    ...
    render() {
        ...
        const { timestampColumnIndex } = this.state
        return (
                    ...
                    <Form onSubmit={this.onSubmit}>
                        <FormGroup>
                            ...
                            <Select
                                ...
                                value={{
                                    [timestampColumnIndex]: `${timestampColumnIndex} ${headers[timestampColumnIndex]}`,
                                }}
