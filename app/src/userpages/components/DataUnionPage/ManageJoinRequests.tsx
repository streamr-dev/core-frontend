                        ...
                        return (
                            <TableRow key={req.id} processing={processing}>
                                ...
                                {processing ? (
                                    ...
                                    <ApproveButton onClick={() => approveSingle(req.id)}>Approve</ApproveButton>
                                )}
                            </TableRow>
                        )
                    })}
                    {pendingRequests.length === 0 && <NoJoinRequests>No join requests waiting for you</NoJoinRequests>}
                </TableRows>
            </Table>
            <Footer>
                <Button
