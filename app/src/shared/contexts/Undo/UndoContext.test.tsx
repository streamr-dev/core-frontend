...
import * as Undo from '$shared/contexts/Undo'
import UndoContext, { UndoContextProps, initialAction } from '$shared/contexts/Undo/UndoContext'
                ...
                <Undo.Provider>
                    <UndoContext.Consumer>
                        {(props) => {
                            ...
                            expect(props.action).toBe(initialAction)
                            return null
                        }}
                    </UndoContext.Consumer>
                </Undo.Provider>,
