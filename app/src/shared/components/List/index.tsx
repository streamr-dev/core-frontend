...
const HeaderItem = ({ asc, desc, active, onClick: onClickProp, children, ...otherProps }) => {
        ...
        <HeaderItemComponent {...otherProps}>
            {!!asc && !!desc && (
                <SortButton type="button" onClick={onClick}>
                    {children}
                    {!!active && !!asc && active === asc && <SvgIcon name="caretUp" />}
                    {!!active && !!desc && active === desc && <SvgIcon name="caretDown" />}
                </SortButton>
            )}
            {(!asc || !desc) && children}
        </HeaderItemComponent>
...
const SelectableRow = ({ id, selectable, active, onClick: onClickProp, ...props }) => {
    const onClick = useCallback(() => {
        if (onClickProp) {
            onClickProp(id)
        }
    ...
    return (
        ...
        >
            {!!selectable && (
                <CheckboxContainer>
                    <Checkbox value={!!active} onChange={() => {}} />
                </CheckboxContainer>
            )}
            <Row {...props} />
        </SelectableRowWrapper>
