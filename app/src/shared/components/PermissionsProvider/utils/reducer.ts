...
export default function reducer(state, action) {
    ...
    if (action.type === SET_PERMISSIONS) {
        return Object.entries(state.changeset).reduce(
            ...
            { ...state, ...normalize(action.permissions), errors: action.errors || {}, locked: false },
        )
    }
    ...
    switch (action.type) {
        ...
        case SET_RESOURCE:
            ...
            return { ...initialState, resourceId: action.resourceId, resourceType: action.resourceType }
        ...
        case REMOVE_PERMISSION:
            ...
            if (state.combinations[user]) {
                return { ...state, changeset: { ...state.changeset, [user]: undefined } }
            }
        ...
        case UPDATE_PERMISSION:
            ...
            return { ...state, changeset: { ...state.changeset, [user]: action.value } }
        ...
        case ABANDON_CHANGES:
            ...
            return { ...state, changeset: (({ [user]: _, ...changeset }) => changeset)(state.changeset) }
