...
const InstallSupportedBrowserDialog = ({ onClose, ...props }: Props) => (
    <ModalPortal>
        <Dialog
            ...
            renderActions={() => (
                <div className={styles.buttonContainer}>
                    ...
                    <Button kind="secondary" tag={Link} href="https://www.google.com/chrome" target="_blank">
                        Chrome
                    </Button>
                    <Button
                        kind="secondary"
        ...
        >
            <PngIcon name="browserNotSupported" className={styles.icon} alt="Browser not supported" />
            <Message>
                <span>Your browser doesn&apos;t support Web3. </span>
                <span>Please use a supported</span>
            </Message>
            <p>browser and try again</p>
        </Dialog>
    </ModalPortal>
)
