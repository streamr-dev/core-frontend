...
import { DetailEditor } from '.'
const stories = storiesOf('Shared/DetailEditor', module)
    .addDecorator(
        styles({
            color: '#323232',
            padding: '5rem',
...
stories.add('default', () => {
    return <div style={{display: 'flex'}}>
        <div style={{marginRight: '20px'}}>
            <DetailEditor
                ...
                selectOptions={[
                    {
                        label: <ChainOption>
                            <ChainIcon chainId={137}/><span>Polygon</span>
                        </ChainOption>,
                        value: 'polygon'
                    },
                    {
                        label: <ChainOption>
                            <ChainIcon chainId={1}/><span>Ethereum</span>
                        </ChainOption>,
                        value: 'ethereum'
                    },
                    {
                        label: <ChainOption>
                            <ChainIcon chainId={100}/><span>Gnosis Chain (xDai)</span>
                        </ChainOption>,
                        value: 'xdai'
                    }
                ]}
        ...
        <div style={{marginRight: '20px'}}>
            <DetailEditor
                defaultIcon={<StandardIcon name={'twitter'}/>}
                hasValueIcon={<StandardIcon name={'twitter'} className={'twitterBlue'}/>}
                instructionText={'Please add Twitter link'}
                ctaButtonText={'Twitter link'}
                onChange={action('detail changed')}
