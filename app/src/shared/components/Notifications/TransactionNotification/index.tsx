...
import { TransactionState } from '$shared/types/common-types'
import { Hash, TransactionEntity } from '$shared/types/web3-types'
        ...
        case transactionStates.FAILED:
            return (
                <div className={styles.container}>
                    ...
                    <span className={styles.title}>
                        There was an error {isPublish ? 'publishing' : 'unpublishing'} your product
                    </span>
                </div>
            )
...
const renderPurchaseComponent = (state: TransactionState | null | undefined) => {
    switch (state) {
        case transactionStates.PENDING:
            return (
                <div className={styles.container}>
        ...
        case transactionStates.FAILED:
            return (
                <div className={styles.container}>
                    <span className={styles.error} />
                    <span className={styles.title}>There was an error subscribing to a product</span>
                </div>
            )
...
const renderUpdateComponent = (state: TransactionState | null | undefined) => {
    switch (state) {
        case transactionStates.PENDING:
            return (
                <div className={styles.container}>
        ...
        case transactionStates.FAILED:
            return (
                <div className={styles.container}>
                    <span className={styles.error} />
                    <span className={styles.title}>There was an error updating your product</span>
                </div>
            )
        ...
        default:
            ...
            return (
                <div className={styles.container}>
                    <span className={styles.error} />
                    <span className={styles.title}>
                        Trying to watch for a transaction hash that is not in the Redux state
                    </span>
                </div>
            )
    }
