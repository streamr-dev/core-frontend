...
const SortableWrap = function ({ onSortStart: onSortStartProp, onSortEnd: onSortEndProp, ...props }: SortableContainerProps) {
    ...
    const onSortStart = useCallback(
        (...args) => {
            ...
            if (typeof onSortStartProp !== 'function') {
                return undefined
            }
    ...
    const onSortEnd = useCallback(
        (...args) => {
            ...
            if (typeof onSortEndProp !== 'function') {
                return undefined
            }
        ...
        <React.Fragment>
            <BodyClass
                className={cx({
                    ...
                    /* disable user-select on body when sorting */
                })}
            />
            <Sortable onSortStart={onSortStart} onSortEnd={onSortEnd} {...props} />
        </React.Fragment>
    )
}
