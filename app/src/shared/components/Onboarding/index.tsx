import { Element as ReactElement, ChildrenArray } from 'react'
...
type Props = {
    children: ChildrenArray<ReactElement<typeof Link> | null>
    // – can be a Link (`null` for a separator)
