...
const WrongNetworkSelectedDialog = ({ onClose, onSwitch, switching, requiredNetwork, currentNetwork }) => {
    ...
    return (
        <ModalPortal>
            ...
            >
                <PngIcon name="wallet" alt="Please switch network" />
                <Text>
                    Please switch to the {requiredNetworkName} network in your
                    <br />
                    Ethereum wallet. It&apos;s currently in {currentNetworkName} network.
                </Text>
            </Dialog>
        </ModalPortal>
    )
