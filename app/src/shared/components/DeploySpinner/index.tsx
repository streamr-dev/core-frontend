...
const SpinnerSvg = () => (
    ...
    >
        ...
        <g clipPath="url(#a)">
            <g fill="none" clipPath="url(#b)" display="block" transform="matrix(1.5 0 0 1.5 -125 -125)">
                <g className={styles.circle} clipPath="url(#c)" display="block" transform="rotate(180 250 250)">
                    <g display="block">
                ...
                <g className={styles.circle} clipPath="url(#d)" display="block" transform="rotate(0 250 250)">
                    <g display="block">
                ...
                <g className={styles.circle} clipPath="url(#e)" display="block" transform="rotate(-90 250 250)">
                    <g display="block">
...
const DeploySpinner = ({ isRunning, showCounter, className }: Props) => {
    ...
    return (
        ...
        >
            <SpinnerSvg />
            {showCounter && <div className={styles.counter}>{toString(elapsedSecs)}</div>}
        </div>
    )
}
