...
describe('BodyClass', () => {
    it('sets/unsets class on mount/unmount', () => {
        ...
        const result = mount(<BodyClass className={className} />)
    ...
    it('can update class via prop', () => {
        ...
        const result = mount(<BodyClass className={className1} />)
        result.setProps({
    ...
    it('does not clobber itself', () => {
        ...
        const result1 = mount(<BodyClass className={className1} />)
        const result2 = mount(<BodyClass className={`${className1} ${className2}`} />)
        const result3 = mount(<BodyClass className={`${className2} ${className3}`} />)
