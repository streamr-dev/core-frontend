export const USER_DATA_REQUEST = 'shared/user/USER_DATA_REQUEST'
export const USER_DATA_SUCCESS = 'shared/user/USER_DATA_SUCCESS'
export const USER_DATA_FAILURE = 'shared/user/USER_DATA_FAILURE'
export const RESET_USER_DATA = 'shared/user/RESET_USER_DATA'
