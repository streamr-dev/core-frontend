...
export const UPDATE_AVATAR_REQUEST = 'shared/user/UPDATE_AVATAR_REQUEST'
export const UPDATE_AVATAR_SUCCESS = 'shared/user/UPDATE_AVATAR_SUCCESS'
export const UPDATE_AVATAR_FAILURE = 'shared/user/UPDATE_AVATAR_FAILURE'
