    ...
    <Root className={className}>
        ...
        <ProductChoices>
            <Product>
                ...
                <ProductImage>
                    <img src={standardProductImage} srcSet={`${standardProductImage2x} 2x`} alt="Data Product" />
                </ProductImage>
                <ProductText>
                    <span>
                        Add your own data stream or group of streams to a product and publish it on the Marketplace. For
                        help creating streams, see the <Link to={docsLinks.streams}>docs</Link>.
                    </span>
                    <Button
                        kind="primary"
                        outline
            ...
            <Product>
                ...
                <ProductText>
                    <span>
                        Gather members via your own app and crowdsell the data they provide. You take a cut, and the
                        rest is distributed to members.
                    </span>
                    <Button
                        kind="primary"
                        outline
