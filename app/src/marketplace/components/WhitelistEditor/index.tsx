...
type CommonProps = {
    enabled: boolean
    onRemove: (arg0: Address) => Promise<void>
    actionsEnabled: boolean
}
type EditorProps = CommonProps & {
    items: Array<WhitelistItem>
    onEnableChanged: (arg0: boolean) => void
    onAdd: () => Promise<void>
}
...
export const UnstyledWhitelistEditor = ({
    ...
    <div {...props}>
        ...
        <Controls>
            ...
            <Toggle id="whitelist" value={enabled} onChange={onEnableChanged} />
            <Button kind="secondary" size="normal" disabled={!enabled || !actionsEnabled} onClick={() => onAdd()}>
                Add to whitelist
            </Button>
        </Controls>
    </div>
