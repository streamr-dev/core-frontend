...
const InnerIcon = ({ name }: { name: string }) => {
    switch (name) {
        ...
        case 'valid':
            return <path strokeLinecap="round" strokeLinejoin="round" d="M5.306 8.19l1.65 1.792 4.243-4.243" />

        case 'error':
            return <path d="M8 5v3.918M7.986 10.904l.014.014" strokeLinecap="round" />
