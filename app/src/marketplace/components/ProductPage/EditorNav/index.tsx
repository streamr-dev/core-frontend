...
const EditorNav = ({ sections, activeSection, showErrors, trackScrolling, className }: Props) => {
        ...
        <div className={cx(styles.root, styles.EditorNav, className)}>
            <div className={styles.progressBar}>
                ...
                <div
                    ...
                    style={{
                        height: !trackScrolling
                            ? '100%'
                            : `${(Math.max(0, highestSeenSection) / Math.max(1, sections.length - 1)) * 100}%`,
                    }}
                />
            </div>
