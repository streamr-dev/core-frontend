...
const TextContainer = ({ children }: ChildrenProps) => <div className={styles.textContainer}>{children}</div>
        ...
        () => (
            <div className={styles.tabContent}>
                {step === 0 && (
                    <React.Fragment>
                        <ThemeProvider theme={tileTheme}>
                            <ImageTile alt={name} height="240px" src={image} />
                        </ThemeProvider>
                        <TextContainer>
                ...
                {step === 1 && (
                    <React.Fragment>
                        <PreviewContainer>
                            <ProductCard name={name} image={image} className={styles.highlightStatus} />
                        </PreviewContainer>
                        <TextContainer>
                            Once deployed, your product is not published, but will appear as
                            <br />a Draft in Core &gt; Products. Publish when it has enough members.
                        </TextContainer>
                    </React.Fragment>
                )}
                {step === 2 && (
