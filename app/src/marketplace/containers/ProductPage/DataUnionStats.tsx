...
const UnstyledDataUnionStats = ({ stats, memberCount, showDeploying, dataUnion, chainId, ...props }: Props) => {
    const [days, setDays] = useState(7)
    return (
        <Segment {...props}>
            <AutoScrollHook hash="stats" />
            <Segment.Header>Overview</Segment.Header>
            {!!showDeploying && (
                <Segment.Body>
                    <DataUnionPending />
                </Segment.Body>
                    ...
                    <Graphs>
                        <Members>
                            <TimeSeriesGraph.Header>
                                <ProductStat.Title>Members</ProductStat.Title>
                        ...
                        <GroupedMembers>
                            <TimeSeriesGraph.Header>
                                <ProductStat.Title>Members by status</ProductStat.Title>
                            </TimeSeriesGraph.Header>
                            <TimeSeriesGraph.Body>
                                <DonutChart
                                    strokeWidth={3}
