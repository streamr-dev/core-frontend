...
const SharedSecrets = ({ className, disabled }: Props) => {
    ...
    return (
        <section id="shared-secrets" className={cx(styles.root, className)}>
            ...
            {!!isDeployed && (
                <p>
                    Shared secrets are the access control for your Data Union. Create, name and revoke shared secrets
                    from here.
                </p>
            )}
            {!isDeployed && (
                <p>
                    These settings are only available once you have deployed your Data Union, and provides access
                    control for your Data Union. Create, name and revoke shared secrets them from here.
                </p>
            )}
