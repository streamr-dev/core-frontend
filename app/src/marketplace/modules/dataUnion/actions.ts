...
const getDataUnionRequest: DataUnionIdActionCreator = createAction(GET_DATA_UNION_REQUEST, (id: DataUnionId) => ({
    id,
}))
...
export const updateDataUnionStats =
    (productIds: ProjectIdList) => (dispatch: (...args: Array<any>) => any, getState: (...args: Array<any>) => any) => {
        ...
        const dataUnionIds = (products || []).reduce((result, { type, beneficiaryAddress }) => {
