...
import type { Product, Filter } from '../../flowtype/product-types'
...
const getProductsSuccess: ProductsActionCreator = createAction(
    GET_PRODUCTS_SUCCESS,
    (products: Array<Product>, hasMore: boolean) => ({
        products,
        hasMore,
    }),
)
