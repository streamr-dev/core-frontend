...
export const toDecimals = (num: string | BN, decimals: string | BN): BN => BN(num).multipliedBy(BN(10).pow(BN(decimals)))

export const fromDecimals = (num: string | BN, decimals: string | BN): BN => BN(num).dividedBy(BN(10).pow(BN(decimals)))
