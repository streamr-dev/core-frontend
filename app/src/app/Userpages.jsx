...
const UserpagesRouter = () => ([
    ...
    <Route exact path={routes.streams.root.show()} component={StreamPage} key="publicStreamPage" />,
    <Route exact path={routes.streams.root.preview()} component={StreamInspectorPage} key="publicStreamPreviewPage" />,
