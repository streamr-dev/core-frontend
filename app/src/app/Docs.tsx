...
const DocsRouter = () => [
    ...
    <Redirect exact from={links.docs} to={links.welcome} key="landingPage" />, // Learn routes
    ...
    <Redirect exact from={links.dataToken} to={links.tokenomics} key="tokenomicsPage" />, // Streamr Network routes
    ...
    <Route exact path={links.mining} component={Mining} key="mining" />, // Streams routes
    ...
    <Route
        exact
        path={links.dataSigningAndVerification}
        component={DataSigningAndVerification}
        key="DSAndVerification"
    />,
    <Route exact path={links.partitioning} component={Partitioning} key="Partitioning" />, // Marketplace routes
    ...
    <Route exact path={links.creatingDataProducts} component={CreatingDataProducts} key="CreatingDataProducts" />, // Data union routes
    ...
    <Route
        exact
        path={links.rolesAndResponsibilities}
    ...
    <Route
        exact
        path={links.joiningAndPartingMembers}
        component={JoiningAndPartingMembers}
        key="joiningAndPartingMembers"
    />,
    <Route exact path={links.withdrawingEarnings} component={WithdrawingEarnings} key="withdrawingEarnings" />,
    <Route exact path={links.uxBestPractices} component={UXBestPractices} key="UXBestPractices" />, // Docs Root/Redirects
