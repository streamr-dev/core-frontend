...
function UnstyledUnwrappedCodeSnippetsSection({ className, disabled }: {className: string, disabled: boolean}) {
    ...
    return (
        <Fragment>
            <p>
                Bring your data to Streamr in the way that works best for you &mdash; as a JS library within your app,
                or via MQTT, HTTP or Websocket.
            </p>
            <Tabs
                className={className}
                footer={
