...
const NewFieldEditor = ({ onStage, onDiscard, onValidate, disabled }) => {
    ...
    return (
        <Container>
            <SplitControl>
                <div>
                    <Label htmlFor="newFieldName" state={validationError && 'ERROR'}>
                        Enter a field name
                    </Label>
                    <Text
                        id="newFieldName"
                        ...
                        disabled={disabled}
                    />
                    <Errors overlap>{validationError}</Errors>
                </div>
                <div>
                    <Label htmlFor="newFieldType">Data type</Label>
                    <Select
                        id="newFieldType"
                        name="type"
                        options={types}
            ...
            <Buttons>
                <Button type="button" kind="secondary" disabled={!canStage} onClick={() => void stage()}>
                    Add
                </Button>
                <Button type="button" kind="link" onClick={() => void onDiscard()} disabled={disabled}>
                    Cancel
                </Button>
            </Buttons>
        </Container>
