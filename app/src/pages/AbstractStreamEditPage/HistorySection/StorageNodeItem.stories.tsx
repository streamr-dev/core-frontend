...
story('StorageNodeItem').add('long location names handling', () => (
    <React.Fragment>
        <StorageNodeItem>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam cursus efficitur orci, at gravida purus varius
            quis. Pellentesque pulvinar ornare purus, eu commodo leo ornare ut. Sed fringilla nibh et urna elementum
            blandit.
        </StorageNodeItem>
