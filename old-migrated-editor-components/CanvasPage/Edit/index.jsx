...
class Canvas extends React.Component { // eslint-disable-line react/no-multi-comp
    state = {}
...
export default connect((state, props) => ({
    ...
    getCanvas,
})(class CanvasList extends Component { // eslint-disable-line react/no-multi-comp
    componentDidMount() {
        this.props.getCanvas(this.props.match.params.id) // eslint-disable-line react/prop-types
    }

    render() {
        return (
            <div className="container">
                <Canvas canvas={this.props.canvas} /> {/* eslint-disable-line react/prop-types */}
            </div>
        )
    }
})
