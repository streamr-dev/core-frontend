...
export default {
    ...
    // Mobile
    iPhoneMobileChrome:
        'Mozilla/5.0 (iPhone; CPU iPhone OS 9_1 like Mac OS X) AppleWebKit/601.1 (KHTML, like Gecko) CriOS/67.0.3396.99 Mobile/13B143 Safari/601.1.46',
    iPhoneMobileFirefox:
        'Mozilla/5.0 (iPhone; CPU iPhone OS 8_3 like Mac OS X) AppleWebKit/600.1.4 (KHTML, like Gecko) FxiOS/1.0 Mobile/12F69 Safari/600.1.4',
    iPhoneMobileOpera:
        'Opera/9.80 (iPhone; Opera Mini/8.0.0/34.2336; U; en) Presto/2.8.119 Version/11.10',
    AndroidMobileBrowser:
