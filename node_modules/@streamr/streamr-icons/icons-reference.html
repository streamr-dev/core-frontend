...
<html lang="en">
  <head>
    ...
    <title>Font Reference - Streamr Icons</title>
    ...
    <div class="container">
      ...
      <ul class="glyphs css-mapping">
        ...
        <li>
          ...
          <input type="text" readonly="readonly" value="cross-circle">
        </li>
        <li>
          <div class="icon icon-data-market"></div>
          <input type="text" readonly="readonly" value="data-market">
        </li>
        <li>
        ...
        <li>
          <div class="icon icon-ethereum"></div>
          <input type="text" readonly="readonly" value="ethereum">
        </li>
        <li>
        ...
        <li>
          <div class="icon icon-message-sent"></div>
          <input type="text" readonly="readonly" value="message-sent">
        </li>
        <li>
        ...
        <li>
          <div class="icon icon-slack"></div>
          <input type="text" readonly="readonly" value="slack">
        </li>
        <li>
          <div class="icon icon-smart-contracts"></div>
          <input type="text" readonly="readonly" value="smart-contracts">
        </li>
        <li>
          <div class="icon icon-socket"></div>
          <input type="text" readonly="readonly" value="socket">
        </li>
        <li>
        ...
        <li>
          <div class="icon icon-streamr-engine"></div>
          <input type="text" readonly="readonly" value="streamr-engine">
        </li>
        <li>
          <div class="icon icon-streamr-network"></div>
          <input type="text" readonly="readonly" value="streamr-network">
        </li>
        <li>
          <div class="icon icon-traffic-light"></div>
          <input type="text" readonly="readonly" value="traffic-light">
        </li>
        <li>
        ...
        <li>
          <div class="icon icon-visual-editor"></div>
          <input type="text" readonly="readonly" value="visual-editor">
        </li>
        <li>
          <div class="icon icon-we-chat"></div>
          <input type="text" readonly="readonly" value="we-chat">
        </li>
        <li>
          <div class="icon icon-www"></div>
          <input type="text" readonly="readonly" value="www">
        </li>
        <li>
