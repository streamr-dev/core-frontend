...
type Props = {
    keyId: ?string, // eslint-disable-line react/no-unused-prop-types
    children?: Node,
    load: Function
}
...
function initClient(keyId: ?string) {
    ...
    return new StreamrClient({ // eslint-disable-line consistent-return
        url: config.wsUrl,
        authKey: keyId,
        autoconnect: true,
...
export function withClient(Child: ComponentType<any>): ComponentType<$Diff<Props, { client: StreamrClient }>> {
    return (props: Props) => (
        <Consumer>
